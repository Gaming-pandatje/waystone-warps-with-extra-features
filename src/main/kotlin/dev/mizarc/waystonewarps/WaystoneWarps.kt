...
import dev.mizarc.waystonewarps.interaction.commands.WarpDefaultGroupCommand
...
class WaystoneWarps: JavaPlugin() {
    ...
    private fun registerDependencies() {
        ...
        val actions = module {
            single { CreateWarp(warpRepository, playerAttributeService, structureBuilderService,
                ...
                configService, warpGroupRepository) }
    ...
    private fun registerCommands() {
        ...
        commandManager.registerCommand(WarpDefaultGroupCommand())
    }
